...
public:
	...
	Eigen::MatrixXcd mChi0OffDiag(double q, double w, double delta, Eigen::VectorXd& Qlist, double L, const bool evenPar);
	...
	// kept for index manipulation reference
	...
	// kept for mathematical reference
	...
	std::complex<double> sumPi0Old(double q, double w, double delta, double Qn, double L);
	Eigen::MatrixXcd mChi0DiagOld(double q, double w, double delta, Eigen::VectorXd& Qlist, double L, const bool evenPar);
	Eigen::MatrixXcd mChi0OffDiagOld(double q, double w, double delta, Eigen::VectorXd& Qlist);

	// consider putting internal functions into private when done
private:
